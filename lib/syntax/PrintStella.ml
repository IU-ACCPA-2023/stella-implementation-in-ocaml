...
and prtExpr (i:int) (e : AbsStella.expr) : doc = match e with
  ...
  |    AbsStella.Let (patternbindings, expr) -> prPrec i 1 (concatD [render "let" ; prtPatternBindingListBNFC 0 patternbindings ; render "in" ; prtExpr 1 expr])
  |    AbsStella.LetRec (patternbindings, expr) -> prPrec i 1 (concatD [render "letrec" ; prtPatternBindingListBNFC 0 patternbindings ; render "in" ; prtExpr 1 expr])
